...
// FromImageGenerationRequest converts an OpenAI image generation request to an Lychee GenerateRequest.
...
// ToImageGenerationResponse converts an Lychee GenerateResponse to an OpenAI ImageGenerationResponse.
...
// FromImageEditRequest converts an OpenAI image edit request to an Lychee GenerateRequest.
