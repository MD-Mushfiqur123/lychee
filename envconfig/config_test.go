...
func TestHost(t *testing.T) {
	cases := map[string]struct {
		...
		"proxy path":          {"https://example.com/lychee", "https://example.com:443/lychee"},
		"lychee.com":          {"lychee.com", "https://lychee.com:443"},
	}

	for name, tt := range cases {
		t.Run(name, func(t *testing.T) {
			t.Setenv("LYCHEE_HOST", tt.value)
...
func TestOrigins(t *testing.T) {
	...
	for _, tt := range cases {
		t.Run(tt.value, func(t *testing.T) {
			t.Setenv("LYCHEE_ORIGINS", tt.value)
...
func TestBool(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("LYCHEE_BOOL", k)
			if b := Bool("LYCHEE_BOOL")(); b != v {
...
func TestUint(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("LYCHEE_UINT", k)
			if i := Uint("LYCHEE_UINT", 11434)(); i != v {
...
func TestLoadTimeout(t *testing.T) {
	...
	for tt, expect := range cases {
		t.Run(tt, func(t *testing.T) {
			t.Setenv("LYCHEE_LOAD_TIMEOUT", tt)
...
func TestVar(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("LYCHEE_VAR", k)
			if s := Var("LYCHEE_VAR"); s != v {
...
func TestContextLength(t *testing.T) {
	...
	for k, v := range cases {
		t.Run(k, func(t *testing.T) {
			t.Setenv("LYCHEE_CONTEXT_LENGTH", k)
