...
`
	devices := parseLlamaServerDevicesWithNative(output, []string{"/lib/lychee", "/lib/lychee/cuda_v13"}, []nativeProbeDevice{{
		Library:             "CUDA",
		Index:               0,
...
Available devices:
  CUDA0: NVIDIA GeForce GTX 1060 6GB (6063 MiB, 5900 MiB free)
`
	devices = parseLlamaServerDevicesWithNative(output, []string{"/lib/lychee", "/lib/lychee/cuda_v12"}, []nativeProbeDevice{{
		Library:             "CUDA",
		Index:               0,
		IndexMatchesBackend: true,
		DeviceID:            "0000:01:00.0",
...
`
	devices := parseLlamaServerDevicesWithNative(output, []string{"/lib/lychee", "/lib/lychee/rocm_v7_2"}, []nativeProbeDevice{{
		Library:             "ROCm",
		Index:               0,
		IndexMatchesBackend: true,
